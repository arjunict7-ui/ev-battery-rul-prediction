...
```
├── notebooks/
│   └── EV_Battery_RUL_v6_1.ipynb     # Full pipeline: preprocessing → modeling → evaluation
├── data/
│   └── ev_battery_data_with_missing.csv
├── report/
│   └── EV_Battery_RUL_Documentation.pdf
├── README.md
└── .gitignore
```
...
jupyter notebook notebooks/EV_Battery_RUL_v6_1.ipynb
```
